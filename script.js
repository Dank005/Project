...
function checkName(name) { 
    ...
    if (regex.test(testName)) { // if testing of first is true 
        document.getElementById(name).style.backgroundColor = colorGood; 
        return true; 
    } 
    
    else {
        document.getElementById(name).style.backgroundColor = colorBad;    
...
function checkDest() { 
    ...
    if (regex.test(testDest)) {
        document.getElementById("Destination").style.backgroundColor = colorGood; 
        document.getElementById("Destination").innerHTML = "Input correct :)"; 
        return true; 
    } 
    
    else {
        document.getElementById("Destination").style.backgroundColor = colorBad; 
